...
class MacrosymbolSize():
    ...
    def GS4GF8(self):
        ...
        for _ in range(runNum):
            loopNum = 100 # 90
            tempDataList = [[random.randint(10,1400) for _ in range(GS)] for _ in range(loopNum)]
            ...
            for i in range(loopNum):
                ...
                Overhead,Operation,MacroSs,LargestItem = self.gotPerformance(GS,tempDataList[i],self.Alg_Small_Fix)
                ...
                # ======================
                Overhead,Operation,MacroSs,LargestItem = self.gotPerformance(GS,tempDataList[i],self.Alg_Small_DynamicV1)
                ...
                # =====================
                Overhead,Operation,MacroSs,LargestItem = self.gotPerformance(GS,tempDataList[i],self.Alg_Small_Dynamicv1_v2)
                ...
                # =====================
                # tempDataList[i].sort()
                Overhead,Operation,MacroSs,LargestItem = self.gotPerformance(GS,tempDataList[i],self.Alg_DynamicV2)
                ...
                # ================
                copy_DataList = copy.copy(tempDataList[i])
                ...
                Overhead = copy_DataList[0] - tempDataList[i][0]
                Overhead += copy_DataList[GS-1] - tempDataList[i][GS-1]
                ...
                for n in range(1,GS-1):
                    ...
                    Overhead += copy_DataList[n] - tempDataList[i][n]
    ...
    def gotPerformance_print(self,tempDataList,algorithm):
        # =====================
        # Algorithm 1 mix
        # ======================
        tempDataList.sort()
...
def GS2GF8_Algorithms():
    ...
    for i in range(runNum):
        loopNum = 90
        dataList = [[random.randint(10,1400) for _ in range(GS)] for _ in range(loopNum)]
        ...
        std_list = [np.std(item) for item in Result_list]
        # OvOp_list.append([mean_list[0],mean_list[1],mean_list[4],mean_list[5]])
        OvOp_list.append([mean_list[19],mean_list[17],mean_list[13],mean_list[9],mean_list[5],mean_list[1],\
                            mean_list[20],mean_list[16],mean_list[12],mean_list[8],mean_list[4],mean_list[0]])
    ...
    keysParament_list = ["Operation mix2","Operation mix1","Operation DynamicV2","Operation DynamicV1","Operation BigFix","OPeration SmallFix",\
                         "Ohead mix2","Ohead mix1","Ohead Small DynamicV2","Ohead DynamicV1","Ohead BigFix","Ohead SmallFix"]
