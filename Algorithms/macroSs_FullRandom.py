...
class MacrosymbolSize():
    ...
    def GS4GF8_fullrandom(self):
        ...
        for _ in range(runNum):
            ...
            twoEdges_OH.append(mean_list[20])
        ...
        print "twoEdge,",np.round(twoEdges_OH)
        self.show_twoEdge_OH(GS,np.round(twoEdges_OH))
...
def GS2GF8_Algorithms():
    ...
    for i in range(runNum):
        ...
        for i in range(loopNum):
            ...
            # ================
            # Algorithm 4 mix dynamicV1 and small fix
            # ================
            ...
            if Quo >= Rem:
                ...
                MacroSs = smaller + (Rem // Quo +1)
                Temp_L1 = larger + (Rem // Quo +1)*Quo - Rem
                Overhead_temp6 = (Rem // Quo +1)*(Quo + 1) - Rem
    ...
    keysParament_list = ["Operation SBDyV1V2","Operation SDyV1","Operation DynamicV2","Operation DynamicV1","Operation BigFix","OPeration SmallFix",\
                         "Ohead SBDyV1V2","Ohead SDyV1","Ohead DynamicV2","Ohead DynamicV1","Ohead BigFix","Ohead SmallFix"]
    
    # keysParament_list = ["Operation SBDyV1V2","Operation SDyV1","Operation DynamicV2","Operation DynamicV1","Operation BigFix","OPeration SmallFix",\
    #                      "Ohead SBDyV1V2","Ohead SDyV1","Ohead Small DynamicV2","Ohead DynamicV1","Ohead BigFix","Ohead SmallFix"]
    ...
    strTitle_tail =  "of Different Algorithms " + str(loopNum)+" times"
    # plt.title(strTitle)
...
if __name__=="__main__":  
    ...
    # MacrosymbolSize().GS4GF8_fullrandom()
